...
class FoodicsConfigure(models.Model):
    ...
    included_taxes_id = fields.Many2many('account.tax', 'product_falla_rel', 'prod_id', 'tax_id', 
        string='Inclusive Customer Taxes',
        domain=[('type_tax_use', '=', 'sale'), ('price_include', '=', True)])
    excluded_taxes_id = fields.Many2many('account.tax', 'product_excluded_falla_rel', 'prod_id', 'tax_id', 
        string='Exclusive Customer Taxes',
